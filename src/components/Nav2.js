...
const Nav2 = () => {
    return (
        <div className="  h-20 bg-white flex justify-around text-xl lg:xl  w-full text-black   " >
         ...
         <div className="  gap-10 items-center cursor-pointer text-lg hidden lg:flex   "   >
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
   ...
   <div className=" flex justify-center items-center  lg:hidden    "   >
        <div className=" flex justify-center items-center cursor-pointer       lg:h-8 lg:w-8 h-12 w-12   "    >
